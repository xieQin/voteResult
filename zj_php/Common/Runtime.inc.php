...
class Runtime {
    ...
    static function url($url_path) {
        return "http://".$_SERVER["SERVER_NAME"].':'.$_SERVER["SERVER_PORT"].getC("APP_URL") . $url_path;
    }

    static function url_action($url_path) {
        return "http://".$_SERVER["SERVER_NAME"].':'.$_SERVER["SERVER_PORT"].getC("APP_URL") . getC("APP_URL_ACTIONTAG") . $url_path;
    }
